exports.seed = function(knex, Promise) {
  return Promise.join(
    ...
    knex('trip').insert({title: 'wyoming', description: 'cabin in wyoming', trip_start: '7/21/16', trip_end: '7/26/16', admin_id: 1, image: 'https://www.selectregistry.com/Uploads/images/Wyoming.jpg'})
  );
};
